...
## Heat Plot of Tuning
```{r Heat Map Plotting, eval = FALSE}
...
## Plotting eta Runs
```{r Plotting eta Runs, eval = FALSE}
...
save(eta_plot, file = './RData/eta_plot.RData')
```
...
```{r Optimal XGBoost Model - With Price, eval = FALSE}
...
```{r XGBoost Run - No Price, eval = FALSE}
...
```{r Waterfall Price 1/3, eval = FALSE}
...
```{r Waterfall Price 3/3, eval = FALSE}
...
```{r Waterfall No Price 1/3, eval = FALSE}
...
```{r Waterfall No Price 3/3, eval = FALSE}
...
```{r Shap Results Price, eval = FALSE}
...
```{r Shap Results No Price, eval = FALSE}
...
```{r Shap Long No Price, eval = FALSE}
